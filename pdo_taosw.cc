...
PHP_MINIT_FUNCTION(pdo_taosw)
{
    ...
    REGISTER_PDO_CLASS_CONST_LONG("PARAM_TAOSW_VARCHAR",  (zend_long)(TSDB_DATA_TYPE_VARCHAR + 6000));
    ...
    REGISTER_PDO_CLASS_CONST_LONG("PARAM_TAOSW_JSON",  (zend_long)(TSDB_DATA_TYPE_JSON + 6000));
    REGISTER_PDO_CLASS_CONST_LONG("PARAM_TAOSW_VARBINARY",  (zend_long)(TSDB_DATA_TYPE_VARBINARY + 6000));
    REGISTER_PDO_CLASS_CONST_LONG("PARAM_TAOSW_DECIMAL",  (zend_long)(TSDB_DATA_TYPE_DECIMAL + 6000));
    REGISTER_PDO_CLASS_CONST_LONG("PARAM_TAOSW_BLOB",  (zend_long)(TSDB_DATA_TYPE_BLOB + 6000));
    REGISTER_PDO_CLASS_CONST_LONG("PARAM_TAOSW_MEDIUMBLOB",  (zend_long)(TSDB_DATA_TYPE_MEDIUMBLOB + 6000));
    REGISTER_PDO_CLASS_CONST_LONG("PARAM_TAOSW_BINARY",  (zend_long)(TSDB_DATA_TYPE_BINARY + 6000));
    REGISTER_PDO_CLASS_CONST_LONG("PARAM_TAOSW_MAX",  (zend_long)(TSDB_DATA_TYPE_MAX + 6000));
